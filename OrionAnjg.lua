...
local function GetIcon(IconName)
    -- Jika IconName ada di tabel, langsung kembalikan nilainya
    if Icons[IconName] then
        return Icons[IconName]
    end
    -- Fallback jika tidak ditemukan (menggunakan ID default)
    return "rbxassetid://3926305904" 
end

-- INI ADALAH BAGIAN YANG MENGGANTIKAN BARIS 79 DAN SEKITARNYA
local Orion = Instance.new("ScreenGui")
Orion.Name = "Orion"

-- Fungsi proteksi GUI agar tidak error di executor apa pun
...
-- Hapus UI lama jika nama sama agar tidak menumpuk (Anti-Lag)
...
for _, Interface in ipairs(ParentContainer:GetChildren()) do
    if Interface.Name == Orion.Name then
        Interface:Destroy()
    end
end
