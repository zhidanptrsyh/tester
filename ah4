...
function Menghub:Window(GuiConfig)
    ...
    ThemeImage.Position = UDim2.new(0.5, 0, 0.5, 0)   -- tengah panel
    ThemeImage.Size = UDim2.new(1, 0, 1, 0)            -- full panel
    ThemeImage.ZIndex = 0
    ThemeImage.Image = "rbxassetid://76239481062153"
    ThemeImage.ImageTransparency = 0.25
    ThemeImage.ScaleType = Enum.ScaleType.Crop          -- CROP, bukan Fit
